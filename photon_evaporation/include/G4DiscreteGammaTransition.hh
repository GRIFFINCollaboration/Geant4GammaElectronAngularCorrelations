...
public:
  ...
  G4double GetThetaFromWTheta(G4double higherLevelEnergy, G4int casenumber); // Rishita -- added casenumber
...
private:
  ...
  // Rishita Gudapati- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  std::vector<G4double> _a2_gg;
  std::vector<G4double> _a4_gg;
  std::vector<G4double> _a6_gg;
  std::vector<G4double> _a8_gg;
  std::vector<G4double> _a10_gg;
  std::vector<G4double> _maxWTheta_gg;

  std::vector<G4double> _a2_ge;
  std::vector<G4double> _a4_ge;
  std::vector<G4double> _a6_ge;
  std::vector<G4double> _a8_ge;
  std::vector<G4double> _a10_ge;
  std::vector<G4double> _maxWTheta_ge;

  std::vector<G4double> _a2_eg;
  std::vector<G4double> _a4_eg;
  std::vector<G4double> _a6_eg;
  std::vector<G4double> _a8_eg;
  std::vector<G4double> _a10_eg;
  std::vector<G4double> _maxWTheta_eg;

  std::vector<G4double> _a2_ee;
  std::vector<G4double> _a4_ee;
  std::vector<G4double> _a6_ee;
  std::vector<G4double> _a8_ee;
  std::vector<G4double> _a10_ee;
  std::vector<G4double> _maxWTheta_ee;
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
};
