...
public:
  ...
  inline G4bool GetElecFirst() { return elecFirst; };
  inline void   SetElecFirst(G4bool value) { elecFirst = value; };

  inline G4int  GetCaseNumber() { return caseNumber; };
  inline void   SetCaseNumber(G4int value) { caseNumber = value; };
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
