...
public:
  ...
  const std::vector<G4double>& AlphL1() const;
  const std::vector<G4double>& AlphL2() const;
  const std::vector<G4double>& Electrue() const;
  ...
  inline void FillalphL1(G4int i, G4double value) { _alphL1[i] = value; };
  inline void FillalphL2(G4int i, G4double value) { _alphL2[i] = value; };
  inline void Fillelectrue(G4int i, G4double value) { _electrue[i] = value; };
