...
//#include "G4ParticleDefinition.hh" // Rishita
...
public:
  ...
  inline G4bool GetFirstProduct() { return firstProduct; };
  inline void   SetFirstProduct(G4bool value) { firstProduct = value; };

  G4int GetCaseNumber() {return case_number;};
  void  SetCaseNumber(G4int value) { case_number = value; };

  G4int GetFirstCase() { return fcase_number; };
  void  SetFirstCase(G4int value) { fcase_number = value; };
...
// Rishita
  ...
  inline void 	  SetLevelEnergy(G4double value) { levelEnergy = value; };

  inline G4double GetTheta() { return theta; };
  inline void 	  SetTheta(G4double value) { theta = value; };
